...
async function cargarFacturacion() {
    try {
                    ...
                    <tbody>
                        ${data.map(factura => `
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-primary" onclick="verFactura(${factura.id})">Ver</button>
                                    <button class="btn btn-secondary" onclick="eliminarFactura(${factura.id})">Eliminar</button>
                                </td>
                            </tr>
                        `).join('')}
                    </tbody>
        ...
        showError('Error al cargar facturación: ' + error.message);
    }
}
